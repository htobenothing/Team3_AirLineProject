<%@ Page Title="" Language="C#" MasterPageFile="~/staff/NestedMasterStaff.master" AutoEventWireup="true" CodeBehind="bAddPassenger.aspx.cs" Inherits="Team3_AirLineProject.staff.bAddPassenger" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">

    <div style="margin: auto; width: 420px; height: 420px;" class="contenthold">
        ...
        <table style="width: 100%; height: 100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:RadioButton ID="RadioButton1" runat="server" GroupName="gender" Text="male" /><asp:RadioButton ID="RadioButton2" runat="server" GroupName="gender" Text="female" /></td>
            </tr>
