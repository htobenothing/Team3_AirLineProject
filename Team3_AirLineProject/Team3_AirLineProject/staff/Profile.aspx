<%@ Page Title="" Language="C#" MasterPageFile="~/staff/NestedMasterStaff.master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="Team3_AirLineProject.staff.Profile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
    <div class="login-card">
        <h1>Profile</h1>
            <br />UserID:<asp:TextBox runat="server" ID="txtUser" placeholder="Enter your email" ReadOnly="true"></asp:TextBox>
            ...
            <br /><asp:Label runat="server" ID="labmessage" ForeColor="Red"></asp:Label>
            <br />Password:<asp:TextBox runat="server" TextMode="Password" ID="txtPassword" placeholder="Enter your Password"></asp:TextBox>
            ...
            <br />ConfirmPassword:<asp:TextBox runat="server" TextMode="Password" ID="txtConfirmPassword" placeholder="Confirm Your Password" ></asp:TextBox>
            ...
            <br />TelephoneNumber:<asp:TextBox runat="server" ID="txtPhoneNumber" placeholder="Enter your Phone Number"></asp:TextBox>
