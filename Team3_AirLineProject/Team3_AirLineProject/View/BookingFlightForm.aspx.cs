...
//using System.Windows.Forms.DataGridViewElementStates;


namespace Team3_AirLineProject
{
    public partial class BookingFlightForm : System.Web.UI.Page
    {
        public static int departureId=0;
        //public string userId = "devi@gmail.com";
           ...
           int PassengerCount=Convert.ToInt32(Session["NoOfPassenger"]);
            ...
            if (SelectPessengerView.Rows.Count > 0)
            {
                ...
                if (count != PassengerCount) {
                    ...
                    Response.Redirect("BookingFlightForm.aspx");
